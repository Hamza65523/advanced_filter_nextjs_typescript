...
const index: NextPage<Props> = ({
  item: { iconValue, price, coverSrc, title, deliveryFee, serviceTime, rating },
}) => {
  return (
    <div>
      <div className="border-2 border-gray-50 rounded-md px-2 py-2 shadow-xl">
        ...
        <div className="">
          <div className="flex justify-between">
            ...
            <span className="bg-red-400 rounded-md p-1 w-9 text-white flex items-center justify-evenly">
              <FontAwesomeIcon
